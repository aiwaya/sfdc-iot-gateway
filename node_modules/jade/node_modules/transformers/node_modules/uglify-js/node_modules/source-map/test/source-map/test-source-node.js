...
define(function (require, exports, module) {
  ...
  exports['test .walk()'] = function (assert, util) {
    var node = new SourceNode(null, null, null,
                              ['(function () {\n',
                               '  ', new SourceNode(1, 0, 'circular-slider.min.js', ['someCall()']), ';\n',
                               '  ', new SourceNode(2, 0, 'b.js', ['if (foo) bar()']), ';\n',
                               '}());']);
    var expected = [
      { str: '(function () {\n', source: null,   line: null, column: null },
      { str: '  ',               source: null,   line: null, column: null },
      { str: 'someCall()',       source: 'circular-slider.min.js', line: 1,    column: 0    },
      { str: ';\n',              source: null,   line: null, column: null },
      { str: '  ',               source: null,   line: null, column: null },
  ...
  exports['test .toStringWithSourceMap()'] = forEachNewline(function (assert, util, nl) {
    var node = new SourceNode(null, null, null,
                              ['(function () {' + nl,
                               '  ',
                                 new SourceNode(1, 0, 'circular-slider.min.js', 'someCall', 'originalCall'),
                                 new SourceNode(1, 8, 'circular-slider.min.js', '()'),
                                 ';' + nl,
    ...
    assert.equal(actual.source, 'circular-slider.min.js');
  ...
  exports['test .fromStringWithSourceMap() complex version'] = forEachNewline(function (assert, util, nl) {
    var input = new SourceNode(null, null, null, [
      "(function() {" + nl,
        "  var Test = {};" + nl,
        "  ", new SourceNode(1, 0, "circular-slider.min.js", "Test.A = { value: 1234 };" + nl),
        "  ", new SourceNode(2, 0, "circular-slider.min.js", "Test.A.x = 'xyz';"), nl,
        "}());" + nl,
        "/* Generated Source */"]);
  ...
  exports['test .toStringWithSourceMap() merging duplicate mappings'] = forEachNewline(function (assert, util, nl) {
    var input = new SourceNode(null, null, null, [
      new SourceNode(1, 0, "circular-slider.min.js", "(function"),
      new SourceNode(1, 0, "circular-slider.min.js", "() {" + nl),
      "  ",
      new SourceNode(1, 0, "circular-slider.min.js", "var Test = "),
  ...
  exports['test .toStringWithSourceMap() multi-line SourceNodes'] = forEachNewline(function (assert, util, nl) {
    var input = new SourceNode(null, null, null, [
      new SourceNode(1, 0, "circular-slider.min.js", "(function() {" + nl + "var nextLine = 1;" + nl + "anotherLine();" + nl),
  ...
  exports['test .toStringWithSourceMap() with consecutive newlines'] = forEachNewline(function (assert, util, nl) {
    var input = new SourceNode(null, null, null, [
      "/***/" + nl + nl,
      new SourceNode(1, 0, "circular-slider.min.js", "'use strict';" + nl),
      new SourceNode(2, 0, "circular-slider.min.js", "a();"),
    ]);
    input = input.toStringWithSourceMap({
      file: 'foo.js'
    });
  ...
  exports['test setSourceContent with toStringWithSourceMap'] = function (assert, util) {
    var aNode = new SourceNode(1, 1, 'circular-slider.min.js', 'a');
    aNode.setSourceContent('circular-slider.min.js', 'someContent');
    var node = new SourceNode(null, null, null,
                              ['(function () {\n',
                               '  ', aNode,
    ...
    assert.equal(map.sources[0], 'circular-slider.min.js');
  ...
  exports['test walkSourceContents'] = function (assert, util) {
    ...
    assert.equal(results[0][0], 'circular-slider.min.js');
